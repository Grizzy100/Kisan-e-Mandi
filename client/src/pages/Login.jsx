...
const Login = () => {
    ...
    try {
      if (isSignup) {
        ...
        if (res?.user) {
          ...
          localStorage.setItem("user", JSON.stringify(res.user)); // ✅ Save auth state
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-green-50 px-4 py-8 font-inria">
      <div className="h-150 bg-white shadow-2xl rounded-3xl w-full max-w-6xl overflow-hidden flex flex-col md:flex-row">
        {/* Left: Auth Form */}
        <div className="md:w-1/2 w-full p-8 sm:p-10 md:p-12">
          ...
          <p className="mt-5 text-gray-600 mb-6">
            {isSignup
          ...
          <form onSubmit={handleSubmit} className="mt-12 space-y-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              />
              <button
                type="button"
